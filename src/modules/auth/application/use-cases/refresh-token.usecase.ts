...
export class RefreshTokenUseCase {
    constructor(
        ...
        private readonly accessTokenProvider: ITokenProvider,
    ...
    async execute(
        ...
        const decoded = this.refreshTokenProvider.verify<RefreshTokenPayload>(dto.refreshToken);
        ...
        const accessToken =
            this.accessTokenProvider.generate(
                payload,
                {
        ...
        const refreshToken = this.refreshTokenProvider.generate(
            payload,
            {
